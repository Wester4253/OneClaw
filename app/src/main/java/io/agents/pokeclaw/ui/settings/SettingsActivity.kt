...
class SettingsActivity : BaseActivity() {
    ...
    private fun toggleExternalAutomation() {
        ...
        ConfirmDialog.showWarm(
            ...
            message = "This lets trusted apps like Tasker, MacroDroid, or ADB start OneClaw tasks with explicit Android intents. Keep it off unless you control the automation that will call it.",
            actionTitle = "Enable",
    ...
    private fun initMenuGroups() {
        ...
        aboutGroup.addMenuItem(
            ...
            title = "GitHub",
            onClick = {
                startActivity(Intent(Intent.ACTION_VIEW, "https://github.com/Wester4253/OneClaw".toUri()))
            },
            showDivider = true
        ).apply {
            setTrailingText("Wester4253/OneClaw")
        }
        ...
        aboutGroup.addMenuItem(
            ...
            title = "Built by",
            onClick = {
                startActivity(Intent(Intent.ACTION_VIEW, "https://github.com/Wester4253".toUri()))
            },
            showDivider = false
        ).apply {
            setTrailingText("Wester4253")
        }
    }
            ...
            AlertDialog.show(
                ...
                onCancel = {
                    shareReportFile(
                        ...
                        subject = "OneClaw bug report ${io.agents.pokeclaw.BuildConfig.VERSION_NAME}",
                        body = """
                            Attach this ZIP to your GitHub issue:
                            https://github.com/Wester4253/OneClaw/issues/new
                        """.trimIndent()
                    )
                }
            )
    ...
    private fun shareDebugReport() {
        buildSupportBundle(
            ...
            shareReportFile(
                ...
                subject = "OneClaw debug report ${io.agents.pokeclaw.BuildConfig.VERSION_NAME}",
                body = "Attach this debug report when reporting a OneClaw issue."
            )
        }
    }
    ...
    private fun openGitHubIssue(report: java.io.File) {
        val issueUri = "https://github.com/Wester4253/OneClaw/issues/new".toUri()
            .buildUpon()
    ...
    private fun buildGitHubIssueBody(report: java.io.File): String {
        return """
            ...
            ## Attachments
            - Attach this ZIP from OneClaw: `${report.name}`
            - If this looks device-specific and you have ADB available, also attach `adb logcat`

            Generated by OneClaw ${io.agents.pokeclaw.BuildConfig.VERSION_NAME}.
        """.trimIndent()
    }
